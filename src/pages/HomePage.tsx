...
const products = [
  {
    ...
    externalLink: 'https://www.quabusiness.shop/',
    comingSoon: false,
  },
  {
    name: 'Buyoo',
    ...
    externalLink: 'https://buyoo-marketplace.vercel.app/',
    externalLinkLabel: 'View Demo',
    badgeLabel: 'Demo Available',
    comingSoon: true,
  },
  {
    name: 'Qua Links',
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center gap-4 flex-wrap">
                    ...
                    {product.externalLink && (
                      ...
                      >
                        {product.externalLinkLabel || 'Visit Platform'} <ExternalLink size={14} />
                      </a>
                    )}
                  </div>
                </div>
                ...
                <div className={`relative h-64 lg:h-auto ${index % 2 === 1 ? 'lg:order-1' : ''}`}>
                  ...
                  {product.externalLink ? (
                    ...
                    >
                      <span className={`w-1.5 h-1.5 rounded-full ${product.badgeLabel ? 'bg-amber-400' : 'bg-green-500 animate-pulse'}`} />
                      {product.badgeLabel || 'Live Platform'}
                    </a>
                  ) : (
                    product.comingSoon && (
